...
HD_PWD='C:/Users/haoxu/Documents/m152a/combinational_gates/combinational_gates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combinational_gates_muxed_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combinational_gates_muxed_tb.tcl
