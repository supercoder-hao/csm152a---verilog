...
HD_PWD='C:/Users/haoxu/Documents/m152a/combinational_gates/combinational_gates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combinational_gates_muxed_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combinational_gates_muxed_tb.tcl -notrace
