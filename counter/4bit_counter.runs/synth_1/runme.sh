...
HD_PWD='C:/Users/haoxu/Documents/m152a/counter/4bit_counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_1m_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_1m_1.tcl
