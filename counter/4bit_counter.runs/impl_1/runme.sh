...
HD_PWD='C:/Users/haoxu/Documents/m152a/counter/4bit_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_1m_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_1m_1.tcl -notrace
