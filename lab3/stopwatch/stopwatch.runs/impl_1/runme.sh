...
HD_PWD='C:/Users/haoxu/Documents/m152a/lab3/stopwatch/stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_t.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_t.tcl -notrace
