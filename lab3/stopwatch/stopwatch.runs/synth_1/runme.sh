...
HD_PWD='C:/Users/haoxu/Documents/m152a/lab3/stopwatch/stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_t.tcl
